...
## Содержание
- [Общее описание проекта](#1-общее-описание-проекта)
- [Архитектура и структура проекта](#2-архитектура-и-структура-проекта)
- [База данных](#3-база-данных)
- [API Reference](#4-api-reference)
- [Алгоритм проверки занятости и защита от двойного бронирования](#5-алгоритм-проверки-занятости-и-защита-от-двойного-бронирования)
- [Ролевая модель и безопасность](#6-ролевая-модель-и-безопасность)
- [Инструкция по локальному запуску](#7-инструкция-по-локальному-запуску)
